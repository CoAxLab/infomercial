...
# Reference 
wsls_2 <- median((filter(tmp, strategy == "E-explore (IG)"))$total_R)
...
tmp %>% 
  ...
  stat_summary(fun.y = median, aes(color=strategy), size=0.3, shape=1) +
...
# Reference 
wsls_3 <- median((filter(tmp, strategy == "E-explore (IG)"))$total_R)
...
# Reference 
wsls_4 <- median((filter(tmp, strategy == "E-explore (IG)"))$total_R)
...
# Reference 
wsls_5 <- median((filter(tmp, strategy == "E-explore (IG)"))$total_R)
...
# Reference 
wsls_6 <- median((filter(tmp, strategy == "E-explore (IG)"))$total_R)
...
# Reference 
wsls_7 <- median((filter(tmp, strategy == "E-explore (IG)"))$total_R)
...
# -------------------------------------------------------------
# Our value
wsls_s <- filter(tmp, strategy == "E-explore (IG)")$median_R
