...
tmp %>% 
  ...
  geom_jitter(width = 0.3, size=0.1, alpha=0.1) +
...
perf <- perf2 + p2 + p3 + p4 + p5 + p6 + p7 +
  ...
  plot_annotation(title = "Reward collection performance",
...
ggsave(paste(name, ".pdf", sep=""), plot=perf, width = 9, height = 7)
```
