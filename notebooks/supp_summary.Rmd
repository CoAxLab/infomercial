...
tmp %>% 
  ...
  geom_hline(aes(yintercept=max(median_val/num_episodes)), 
             color="chartreuse4",
             size=0.3) +
  labs(x="", y="Info. value", title="Extrinsic + Intrinsic") +
  lims(y=c(0.0, 0.0125)) +
  scale_color_identity() +
  theme_pubr(base_size = 7, legend = "none") +
  theme(strip.background = element_blank()) +
...
tmp %>% 
  ...
  scale_y_continuous(limits = c(0.0, 0.00002), breaks=c(0.0, 0.00001, 0.00002)) +
  scale_color_identity() +
  theme_pubr(base_size = 7, legend = "none") +
  theme(strip.background = element_blank()) +
  coord_flip() -> p1
