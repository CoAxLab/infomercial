...
example_trace4 <- read_csv(paste(data_path, "example_traces_epsilon_DeceptiveBanditOneHigh10-v0.csv", sep=""))
example_trace4$env <- rep("DeceptiveBanditOneHigh10-v0", nrow(example_trace4))
example_trace5 <- read_csv(paste(data_path, "example_traces_eta_DeceptiveBanditOneHigh10-v0.csv", sep=""))
example_trace5$env <- rep("DeceptiveBanditOneHigh10-v0", nrow(example_trace5))
example_trace6 <- read_csv(paste(data_path, "example_traces_softbeta_DeceptiveBanditOneHigh10-v0.csv", sep=""))
example_trace6$env <- rep("DeceptiveBanditOneHigh10-v0", nrow(example_trace6))
