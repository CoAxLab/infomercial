...
robust <- robust1 + p2 + p3 + p4 + p6 + guide_area() +
  plot_layout(design = layout, guides = "collect") +
  plot_annotation(title = "Robustness of exploration strategies on bandits",
...
# Save
name <- "img/robust"
ggsave(paste(name, ".pdf", sep=""), plot=robust, width = 11, height = 5)
ggsave(paste(name, ".png", sep=""), plot=robust, width = 11, height = 5)
```