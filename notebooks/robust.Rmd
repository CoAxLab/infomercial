...
tune_task2$agent <-
  factor(tune_task2$agent, levels = agent_names)
tune_task2$strategy <-
...
# Our value
wsls_R <- filter(tmp, strategy == "Info.")$median_R
...
# Save
name <- "img/robust"
ggsave(paste(name, ".pdf", sep=""), plot=robust, width = 9, height = 6)
```