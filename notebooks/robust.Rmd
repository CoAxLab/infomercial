...
result_ranked4$agent <-
  factor(result_ranked4$agent, levels = agent_names)
...
# Order factors for later vis
result_ranked121$agent <-
  factor(result_ranked121$agent, levels = agent_names)
result_ranked121$strategy <-
  factor(result_ranked121$strategy,
         levels = c("Info.", "Reward", "Mixed"))
```
...
# Write pdf
name <- "img/robust2"
ggsave(paste(name, ".pdf", sep=""), plot=robust2, width = 6, height = 2.5)
```
