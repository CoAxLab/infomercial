---
title: "Exp344 - InfoBlueYellow4a, 100 experiments (seeds) with and without initial values in M."
...
for (actor in actor_names){
  for (mem in initial_memory){
    for (run in run_codes) {
      ...
      result344 <- bind_rows(result344, runtmp)  
    }
  }
}
...
summary344$actor <- factor(summary344$actor, levels=c("DeterministicActor", "ThresholdActor", "SoftmaxActor", "RandomActor"))
```
