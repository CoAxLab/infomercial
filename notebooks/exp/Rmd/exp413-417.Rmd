---
title: "exp413-417 - DeceptiveBanditOneHigh10 - top10 param runs"
...
result413 <- load.result(exp_name, param_codes, run_codes, file_names)
result413 %>% 
  group_by(param, run) %>% 
...
result414 <- load.result(exp_name, param_codes, run_codes, file_names)
result414 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result415 <- load.result(exp_name, param_codes, run_codes, file_names)
result415 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result416 <- load.result(exp_name, param_codes, run_codes, file_names)
result416 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result417 <- load.result(exp_name, param_codes, run_codes, file_names)
result417 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result413_417 <- tmp1
result413_417 <- bind_rows(result413_417, tmp2)
result413_417 <- bind_rows(result413_417, tmp3)
result413_417 <- bind_rows(result413_417, tmp4)
result413_417 <- bind_rows(result413_417, tmp5)
...
summary413_417 <- tmp1
summary413_417 <- bind_rows(summary413_417, tmp2)
summary413_417 <- bind_rows(summary413_417, tmp3)
summary413_417 <- bind_rows(summary413_417, tmp4)
summary413_417 <- bind_rows(summary413_417, tmp5)
```
