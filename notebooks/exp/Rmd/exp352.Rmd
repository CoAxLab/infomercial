---
title: "Exp352 - Animals as paramters - 100 experiments (constant intial value)"
...
for (i in 1:length(actor_names)){
  ...
  for (run in run_codes) {
    ...
    result352 <- bind_rows(result352, runtmp)  
  }
}
...
# --
summary352$actor <- factor(summary352$actor, 
