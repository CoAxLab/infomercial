---
title: "exp444-448 - DeceptiveBanditOneHigh10 - top10 param runs"
...
result444 <- load.result(exp_name, param_codes, run_codes, file_names)
result444 %>% 
  group_by(param, run) %>% 
...
result445 <- load.result(exp_name, param_codes, run_codes, file_names)
result445 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result446 <- load.result(exp_name, param_codes, run_codes, file_names)
result446 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result447 <- load.result(exp_name, param_codes, run_codes, file_names)
result447 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result448 <- load.result(exp_name, param_codes, run_codes, file_names)
result448 %>% 
  group_by(param, run) %>% 
  filter(global_step <= 100) %>% 
  summarise(
...
result444_448 <- tmp1
result444_448 <- bind_rows(result444_448, tmp2)
result444_448 <- bind_rows(result444_448, tmp3)
result444_448 <- bind_rows(result444_448, tmp4)
result444_448 <- bind_rows(result444_448, tmp5)
...
summary444_448 <- tmp1
summary444_448 <- bind_rows(summary444_448, tmp2)
summary444_448 <- bind_rows(summary444_448, tmp3)
summary444_448 <- bind_rows(summary444_448, tmp4)
summary444_448 <- bind_rows(summary444_448, tmp5)
```
