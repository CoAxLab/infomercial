---
title: "exp398-401 - BanditOneHigh4 - top10 param runs"
...
result398 <- load.result(exp_name, param_codes, run_codes, file_names)
result398 %>% 
  group_by(param, run) %>% 
  summarise(
    total_E=max(total_E),
...
result399 <- load.result(exp_name, param_codes, run_codes, file_names)
result399 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=max(total_R),
...
result400 <- load.result(exp_name, param_codes, run_codes, file_names)
result400 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=max(total_R),
...
result401 <- load.result(exp_name, param_codes, run_codes, file_names)
result401 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=max(total_R),
...
result398_401 <- tmp1
result398_401 <- bind_rows(result398_401, tmp2)
result398_401 <- bind_rows(result398_401, tmp3)
result398_401 <- bind_rows(result398_401, tmp4)
...
summary398_401 <- tmp1
summary398_401 <- bind_rows(summary398_401, tmp2)
summary398_401 <- bind_rows(summary398_401, tmp3)
summary398_401 <- bind_rows(summary398_401, tmp4)
```
