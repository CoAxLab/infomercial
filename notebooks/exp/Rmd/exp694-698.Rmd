---
title: "exp694-698 : BanditChange121 - Alt memories - Top 10"
...
tmp %>%
  ...
  geom_point(size = 0.5) +
  facet_grid(interaction(param, run) ~ agent) +
...
# ----------------------------------------------------------------------------------------
n <- 121 * 100
max_R <- max(result694_698$total_R)
...
tmp %>% 
  ...
  ggplot(aes(x=agent, y=total_R/max_R, color=color)) +
  geom_boxplot(outlier.size = 0, width=0.5) +
  labs(x="", y="Relative reward", title="Alt. memories") +
