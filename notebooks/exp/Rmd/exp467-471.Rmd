---
title: "exp467 - 471 : DistractionBanditOneHigh10 - with **wrong** top10 params"
...
result467 <- load.result(exp_name, param_codes, run_codes, file_names)
result467 %>% 
  group_by(param, run) %>% 
  summarise(
...
result468 <- load.result(exp_name, param_codes, run_codes, file_names)
result468 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result469 <- load.result(exp_name, param_codes, run_codes, file_names)
result469 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result470 <- load.result(exp_name, param_codes, run_codes, file_names)
result470 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result471 <- load.result(exp_name, param_codes, run_codes, file_names)
result471 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result467_471 <- tmp1
result467_471 <- bind_rows(result467_471, tmp2)
result467_471 <- bind_rows(result467_471, tmp3)
result467_471 <- bind_rows(result467_471, tmp4)
result467_471 <- bind_rows(result467_471, tmp5)
...
summary467_471 <- tmp1
summary467_471 <- bind_rows(summary467_471, tmp2)
summary467_471 <- bind_rows(summary467_471, tmp3)
summary467_471 <- bind_rows(summary467_471, tmp4)
summary467_471 <- bind_rows(summary467_471, tmp5)
```
