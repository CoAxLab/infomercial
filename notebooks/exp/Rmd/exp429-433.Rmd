---
title: "exp429 - 433 - BanditHardAndSparse10 - top10 param runs"
...
result429 <- load.result(exp_name, param_codes, run_codes, file_names)
result429 %>% 
  group_by(param, run) %>% 
  summarise(
...
result430 <- load.result(exp_name, param_codes, run_codes, file_names)
result430 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result431 <- load.result(exp_name, param_codes, run_codes, file_names)
result431 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result432 <- load.result(exp_name, param_codes, run_codes, file_names)
result432 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result433 <- load.result(exp_name, param_codes, run_codes, file_names)
result433 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
# 
# result429_433 <- tmp1
# result429_433 <- bind_rows(result429_433, tmp2)
# result429_433 <- bind_rows(result429_433, tmp3)
# result429_433 <- bind_rows(result429_433, tmp4)
# result429_433 <- bind_rows(result429_433, tmp5)
...
summary429_433 <- tmp1
summary429_433 <- bind_rows(summary429_433, tmp2)
summary429_433 <- bind_rows(summary429_433, tmp3)
summary429_433 <- bind_rows(summary429_433, tmp4)
summary429_433 <- bind_rows(summary429_433, tmp5)
rm(tmp1, tmp2, tmp3, tmp4, tmp5)
```
...
summary429_433 %>% 
  ...
  geom_jitter(size=0.01, alpha=0.9, width=0.2) +
  stat_summary(fun=median, alpha=0.6, size=1, shape="|") +
