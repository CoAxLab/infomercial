---
title: "exp434 - 438 - BanditOneHigh10 - top10 param runs"
...
result434 <- load.result(exp_name, param_codes, run_codes, file_names)
result434 %>% 
  group_by(param, run) %>% 
  summarise(
...
result435 <- load.result(exp_name, param_codes, run_codes, file_names)
result435 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result436 <- load.result(exp_name, param_codes, run_codes, file_names)
result436 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result437 <- load.result(exp_name, param_codes, run_codes, file_names)
result437 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result438 <- load.result(exp_name, param_codes, run_codes, file_names)
result438 %>% 
  group_by(param, run) %>% 
  summarise(
    total_R=last(total_R),
...
result434_438 <- tmp1
result434_438 <- bind_rows(result434_438, tmp2)
result434_438 <- bind_rows(result434_438, tmp3)
result434_438 <- bind_rows(result434_438, tmp4)
result434_438 <- bind_rows(result434_438, tmp5)
...
summary434_438 <- tmp1
summary434_438 <- bind_rows(summary434_438, tmp2)
summary434_438 <- bind_rows(summary434_438, tmp3)
summary434_438 <- bind_rows(summary434_438, tmp4)
summary434_438 <- bind_rows(summary434_438, tmp5)
```
...
summary434_438 %>% 
  ...
  geom_jitter(size=0.01, alpha=0.9, width=0.15) +
...
summary434_438 %>% 
  ...
  geom_jitter(size=0.05, alpha=0.9, width=0.15) +
  scale_colour_manual("", values=c("dodgerblue4", "mediumorchid4")) +
  stat_summary(fun=median, alpha=1, size=1, shape="|") +
  labs(y="Best choice", x="") +
  lims(y=c(0,1)) +
