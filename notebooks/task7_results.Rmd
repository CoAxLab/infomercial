...
tmp %>% 
  mutate(
    fill = ifelse(strategy == "E-explore", "chartreuse4", "black")) %>% 
...
# Med R for curiosity
wsls_R <- median((filter(tmp, strategy == "E-explore"))$median_R)
...
# Med R for curiosity
wsls_R <- median((filter(tmp, strategy == "E-explore"))$var_R)
