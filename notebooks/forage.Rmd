...
targets_x <-
  read_csv(paste(data_path, "test6/run0/x_target.csv", sep = ""),
           show_col_types = FALSE)
targets_y <-
  read_csv(paste(data_path, "test6/run0/y_target.csv", sep = ""),
           show_col_types = FALSE)

target_values <-
  read_csv(paste(data_path, "test6/run0/value_target.csv", sep = ""),
           show_col_types = FALSE)
