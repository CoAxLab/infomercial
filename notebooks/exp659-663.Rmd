...
for(i in 1:length(exp_names)){
  ...
  result659_663 <- bind_rows(result659_663, tmp)
}

# ----------------------------------------------------------------------------
# post-process
# Force order
result659_663$agent <- factor(result659_663$agent, levels=rev(agent_names))

# Policy as factors
# Rename levels
result659_663$policy <- as.factor(result659_663$policy)
result659_663$policy <- recode_factor(result659_663$policy, `0`="explore", `1`="exploit")
