...
# Fig 2 - Bandits
## Build
```{r, fig.width=2.4, fig.height=1.3}
# ------------------------------------------------------------------------
...
head1 <- textGrob("Multi-armed bandits", vjust=0.5, gp = gpar(fontsize = 13))
plot_grid <- rbind(
  rep(5, 16),
  c(rep(NA, 4), rep(1, 4), rep(2, 4), rep(3, 4)),
  c(rep(NA, 4), rep(1, 4), rep(2, 4), rep(3, 4)),
  c(rep(NA, 4), rep(1, 4), rep(2, 4), rep(3, 4)),
  c(rep(NA, 4), rep(1, 4), rep(2, 4), rep(3, 4)),
  # c(rep(NA, 4), rep(1, 4), rep(2, 4), rep(3, 4)),
...
ggsave("img/fig2.png", fig2, width=2.4*2, height=1.3*2, dpi = 300)
```
