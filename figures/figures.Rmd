...
memory %>% 
  ...
  labs(x="State", y="State probability", tag="A") +
...
memory %>% 
  ...
  labs(x="Arm", y="Reward probability", tag="B") +
...
flux %>% 
  ...
  labs(x=TeX("Total change in probability, $|\\Delta P|$"), y="KL", tag="C") +
...
local %>% 
  ...
  labs(x="Arm", y="Reward prob.", tag="E") +
...
## Build
```{r, fig.width=5.4, fig.height=1.7}
local_y <- textGrob(" ", vjust=, rot=90, gp = gpar(fontsize = 12))
head1 <- textGrob("Memory, specificity, and value", vjust=0, gp = gpar(fontsize = 13))

plot_grid <- rbind(
  # c(1, 1, NA, NA, NA, NA, NA),
  c(1, 1, 1, NA, 3, 3, 3, 3, NA,6, 6, 6, 6, 6),
  c(1, 1, 1, NA, 3, 3, 3, 3, 5, 4, 4, 4, 4, 4),
  c(1, 1, 1, NA, 3, 3, 3, 3, 5, 4, 4, 4, 4, 4),
  c(1, 1, 1, NA, 3, 3, 3, 3, 5, 4, 4, 4, 4, 4),
  c(1, 1, 1, NA, 3, 3, 3, 3, 5, 4, 4, 4, 4, 4),
  c(1, 1, 1, NA, 3, 3, 3, 3, 5, 4, 4, 4, 4, 4),
  c(1, 1, 1, 2,  2, 2, 2, 2, 5, 4, 4, 4, 4, 4),
  c(1, 1, 1, 2,  2, 2, 2, 2, 2, 4, 4, 4, 4, 4)
)
fig2 <- grid.arrange(sub1, sub2, sub3, sub4, local_y, head1, layout_matrix=plot_grid)
ggsave("img/fig2.png", fig2, width=5.4*2, height=1.7*2)
```
...
value_traces %>% 
  ...
  ggtitle("Exploration dynamics (eta)") +
  labs(x="Episode", y="log(Value)", tag="B") +
  theme_classic() +
...
perf1 <- textGrob("Agent performance", vjust=0, hjust=.55, gp =  gpar(fontsize = 13))
...
plot_grid <- rbind(
  c(NA, 15,15,15, 15,NA,NA,NA,NA,NA,16,16,16,16,16, 16,16),
  ...
  c(13, 3, 3, NA, 17,17,17,17,17,14, 7, 7, 7, 7, 11,11,11),
  c(13, 3, 3, NA, 17,17,17,17,17,14, 7, 7, 7, 7, 11,11,11),
  c(13, 4, 4, 4,  4, 4, 4, 4, 4, 4,  8, 8, 8, 8, 12,12,12),
  c(13, 4, 4, 4,  4, 4, 4, 4, 4, 4,  8, 8, 8, 8, 12,12,12),
  c(13, 4, 4, 4,  4, 4, 4, 4, 4, 4,  8, 8, 8, 8, 12,12,12)
)

fig3 <- grid.arrange(bandit1, bandit2, bandit3, bandit4, 
...
ggsave("img/fig3.png", fig3, width=5*2, height=2.7*2)
```
