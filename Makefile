...
test1:
	...
	parallel -j 39 \
			...
			'wsls_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=200 --tie_break='next' --tie_threshold=1e-5 --mode='KL' --lr_R=.1 --log_dir=$(DATA_PATH)/test1/run{1} --master_seed={1} --output=False' ::: {0..60}
...
test2:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softbeta_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=200 --temp=0.2 --beta=0.5 --bonus=0 --lr_R=.1 --log_dir=$(DATA_PATH)/test2/run{1}  --master_seed={1} --output=False' ::: {0..60}
...
test3:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softcount_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=200 --temp=0.2 --beta=0.5 --lr_R=.1 --mode='UCB' --log_dir=$(DATA_PATH)/test3/run{1} --master_seed={1} --output=False' ::: {0..60}
...
test4:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softentropy_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=200 --temp=0.2 --beta=0.5 --lr_R=.1 --log_dir=$(DATA_PATH)/test4/run{1} --master_seed={1} --output=False' ::: {0..60}
...
test5:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'epsilon_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=200 --epsilon=0.1 --epsilon_decay_tau=0 --lr_R=.1 --log_dir=$(DATA_PATH)/test5/run{1} --master_seed={1} --output=False' ::: {0..60}
...
# abad302
# 
# More tuning exps w/ alt memories. See exp622-25 for prev. 
#
# This time the env is DeceptiveBanditOneHigh10-v0

# L1 (a bayes model) 
exp636:
	tune_bandit.py random $(DATA_PATH)/exp636 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# delta H (ala Calhoun)
exp637:
	tune_bandit.py random $(DATA_PATH)/exp637 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# delta rate / l2
exp638:
	tune_bandit.py random $(DATA_PATH)/exp638 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# UCB (count model 1)
exp639:
	tune_bandit.py random $(DATA_PATH)/exp639 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# EB  (count model 2)
exp640:
	tune_bandit.py random $(DATA_PATH)/exp640 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# KL  (the ref model)
exp641:
	tune_bandit.py random $(DATA_PATH)/exp641 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# L2 (a bayes model)
exp642:
	tune_bandit.py random $(DATA_PATH)/exp642 \
		--exp_name='wsls_bandit' \
		--env_name=DeceptiveBanditOneHigh10-v0 \
		--num_samples=1000 \
		--num_episodes=30 \
...
# More tuning exps w/ alt memories. See exp622-25 for prev. 
#
# This time the env is BanditHardAndSparse10-v0

# L1 (a bayes model) 
exp643:
	tune_bandit.py random $(DATA_PATH)/exp643 \
		--exp_name='wsls_bandit' \
		--env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
# delta H (ala Calhoun)
exp644:
	tune_bandit.py random $(DATA_PATH)/exp644 \
		--exp_name='wsls_bandit' \
		---env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
# delta rate / l2
exp645:
	tune_bandit.py random $(DATA_PATH)/exp645 \
		--exp_name='wsls_bandit' \
		--env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
# UCB (count model 1)
exp646:
	tune_bandit.py random $(DATA_PATH)/exp646 \
		--exp_name='wsls_bandit' \
		--env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
# EB  (count model 2)
exp647:
	tune_bandit.py random $(DATA_PATH)/exp647 \
		--exp_name='wsls_bandit' \
		--env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
# KL  (the ref model)
exp648:
	tune_bandit.py random $(DATA_PATH)/exp648 \
		--exp_name='wsls_bandit' \
		--env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
# L2 (a bayes model)
exp649:
	tune_bandit.py random $(DATA_PATH)/exp649 \
		--exp_name='wsls_bandit' \
		--env_name=BanditHardAndSparse10-v0 \
		--num_samples=1000 \
		--num_episodes=10000 \
...
exp657:
	...
	parallel -j 39 \
			...
			--nice 19 --delay 0 --colsep ',' --header : \
			'forage.py chemotaxis --num_episodes=200 --num_steps=200 --scale=1.0 --log_dir=$(DATA_PATH)/exp657/param0/run{1} --master_seed={1} --output=False' ::: {0..100} 
...
exp659:
	...
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold={tie_threshold} --lr_R=0.01 --mode='L1' --log_dir=$(DATA_PATH)/exp659/param{index}/run{1} --master_seed={1} --output=False' ::: {0..10} :::: tmp
	# Clean up
	rm tmp


# delta Entropy (tune: exp623)
exp660:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp623_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
			--joblog '$(DATA_PATH)/exp660.log' \
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold={tie_threshold} --lr_R=0.01 --mode='H' --log_dir=$(DATA_PATH)/exp660/param{index}/run{1} --master_seed={1} --output=False' ::: {0..10} :::: tmp
	# Clean up
	rm tmp
...
exp661:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp624_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
			--joblog '$(DATA_PATH)/exp661.log' \
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold={tie_threshold} --lr_R=0.01 --mode='rate' --log_dir=$(DATA_PATH)/exp661/param{index}/run{1} --master_seed={1} --output=False' ::: {0..10} :::: tmp
	# Clean up
	rm tmp

# UCB (count model 1) (tune: exp625)
exp662:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp625_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
			--joblog '$(DATA_PATH)/exp662.log' \
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold={tie_threshold} --lr_R=0.01 --mode='UCB' --log_dir=$(DATA_PATH)/exp662/param{index}/run{1} --master_seed={1} --output=False' ::: {0..10} :::: tmp
	# Clean up
	rm tmp


# Skip EB (add little to the story) 

# KL (tune: exp627)
exp663:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp627_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
			--joblog '$(DATA_PATH)/exp663.log' \
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold={tie_threshold} --lr_R=0.01 --mode='KL' --log_dir=$(DATA_PATH)/exp663/param{index}/run{1} --master_seed={1} --output=False' ::: {0..10} :::: tmp
	# Clean up
	rm tmp
...
exp664:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp629_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
...
# delta Entropy (tune: exp630)
exp665:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp630_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
...
# delta rate / l2 (tune: exp631)
exp666:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp631_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
...
# UCB (count model 1) (tune: exp632)
exp667:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp632_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
...
exp668:
	# Get top 10
	head -n 11 $(DATA_PATH)/exp634_sorted.csv > tmp 
	# Run them 10 times
	parallel -j 39 \
...
exp679:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold=0.125 --lr_R=0.1 --mode='L1' --log_dir=$(DATA_PATH)/exp679/param0/run{1} --master_seed={1} --output=False' ::: {0..25} 
...
exp680:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold=0.015 --lr_R=0.1 --mode='H' --log_dir=$(DATA_PATH)/exp680/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp681:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold=0.25 --lr_R=0.1 --mode='rate' --log_dir=$(DATA_PATH)/exp681/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp682:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold=0.5 --lr_R=0.1 --mode='UCB' --log_dir=$(DATA_PATH)/exp682/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp683:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold=0.0075 --lr_R=0.1 --mode='KL' --log_dir=$(DATA_PATH)/exp683/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp684:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditUniform121-v0 --num_episodes=12100 --tie_break='next' --tie_threshold=0.0075 --lr_R=0.125 --mode='L1' --log_dir=$(DATA_PATH)/exp684/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp685:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditUniform121-v0 --num_episodes=12100 --tie_break='next' --tie_threshold=0.25 --lr_R=0.2 --mode='H' --log_dir=$(DATA_PATH)/exp685/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp686:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditUniform121-v0 --num_episodes=12100 --tie_break='next' --tie_threshold=0.06 --lr_R=0.25 --mode='rate' --log_dir=$(DATA_PATH)/exp686/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp687:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditUniform121-v0 --num_episodes=12100 --tie_break='next' --tie_threshold=0.0001 --lr_R=0.06 --mode='UCB' --log_dir=$(DATA_PATH)/exp687/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
...
exp688:
	parallel -j 39 \
			...
			--nice 19 --delay 0 --bar --colsep ',' --header : \
			'wsls_bandit.py --env_name=BanditUniform121-v0 --num_episodes=12100 --tie_break='next' --tie_threshold=0.0075 --lr_R=0.37 --mode='KL' --log_dir=$(DATA_PATH)/exp688/param0/run{1} --master_seed={1} --output=False' ::: {0..100}
