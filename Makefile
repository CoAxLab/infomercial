...
test2:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softbeta_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=60 --temp=0.2 --beta=0.5 --bonus=0 --lr_R=.1 --log_dir=$(DATA_PATH)/test2/run{1}  --master_seed={1} --output=False' ::: {0..60}
...
test3:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softcount_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=60 --temp=0.2 --beta=0.5 --lr_R=.1 --mode='UCB' --log_dir=$(DATA_PATH)/test3/run{1} --master_seed={1} --output=False' ::: {0..60}
...
test5:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'epsilon_bandit.py --env_name=DeceptiveBanditOneHigh10-v0 --num_episodes=60 --epsilon=0.1 --epsilon_decay_tau=0 --lr_R=.1 --log_dir=$(DATA_PATH)/test5/run{1} --master_seed={1} --output=False' ::: {0..60}
