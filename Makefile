...
test1:
	...
	parallel -j 39 \
			...
			'wsls_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --tie_break='next' --tie_threshold=1e-2 --mode='rate' --lr_R=.1 --log_dir=$(DATA_PATH)/test1/run{1} --master_seed={1} --output=False' ::: {0..100}
...
test2:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softbeta_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --temp=0.2 --beta=0.5 --bonus=0 --lr_R=.1 --log_dir=$(DATA_PATH)/test2/run{1}  --master_seed={1} --output=False' ::: {0..100}
...
test3:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softcount_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --temp=0.2 --beta=0.5 --lr_R=.1 --mode='UCB' --log_dir=$(DATA_PATH)/test3/run{1} --master_seed={1} --output=False' ::: {0..100}
...
test4:
	...
	parallel -j 39 \
			--nice 19 --delay 2 --colsep ',' --bar \
			'softentropy_bandit.py --env_name=BanditOneHigh4-v0 --num_episodes=200 --temp=0.2 --beta=0.5 --lr_R=.1 --log_dir=$(DATA_PATH)/test4/run{1} --master_seed={1} --output=False' ::: {0..100}
