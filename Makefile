...
exp1:
	parallel -j 1 -v \
			...
			'meta_bandit.py --env_name BanditOneHot2-v0 --num_episodes=10 --policy_mode='meta' --tie_break='next' --tie_threshold=1e-8 --lr=.1 --save=$(DATA_PATH)/exp1_{1}.pkl --interactive=False --seed_value={1}' ::: 1 2
