...
exp2:
	parallel -j 40 -v \
			...
			--nice 19 --delay 2 --colsep ',' \
			'info_bandit.py --env_name {2}-v0 --num_episodes=10000 --policy_mode='meta' --tie_break='next' --tie_threshold=1e-8 --lr=.1 --save=data/exp2__{2}_{1}.pkl --seed_value={1}' ::: {1..50} ::: BanditOneHot2-v0 BanditOneHot10-v0 BanditOneHot121-v0 BanditOneHot1000-v0 BanditOneHigh2 BanditOneHigh10 BanditOneHigh121 BanditOneHigh1000 BanditHardAndSparse2 BanditHardAndSparse10 BanditHardAndSparse121 BanditHardAndSparse1000